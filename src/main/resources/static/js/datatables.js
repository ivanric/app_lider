 ...
 *   https://datatables.net/download/#bs5/dt-1.13.2/b-2.3.4/r-2.4.0/rg-1.3.0/sc-2.1.0
 *
 * Included libraries:
 *   DataTables 1.13.2, Buttons 2.3.4, Responsive 2.4.0, RowGroup 1.3.0, Scroller 2.1.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.2/b-2.3.4/r-2.4.0/rg-1.3.0/sc-2.1.0",
